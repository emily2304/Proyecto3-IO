...
Maximizar $Z = 12 x_{A} + 10 x_{B}$\\

\textbf{Restricción:}\\
$4 x_{A} + 3 x_{B} \leq 10$\\

\textbf{Restricciones de variables:}\\
$x_i \in \{0, 1\} \quad \forall i \in \{A, B\}$\\
\vspace{0.5cm}
...
3 & \cellcolor{rojo}\textcolor{white}{0} & \cellcolor{verde}\textcolor{white}{10} \\ \hline
4 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{rojo}\textcolor{white}{12} \\ \hline
5 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{rojo}\textcolor{white}{12} \\ \hline
6 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{rojo}\textcolor{white}{12} \\ \hline
7 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{verde}\textcolor{white}{22} \\ \hline
8 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{verde}\textcolor{white}{22} \\ \hline
9 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{verde}\textcolor{white}{22} \\ \hline
10 & \cellcolor{verde}\textcolor{white}{12} & \cellcolor{verde}\textcolor{white}{22} \\ \hline
\end{tabular}
\end{center}
\normalsize
