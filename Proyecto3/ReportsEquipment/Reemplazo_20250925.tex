...
A continuación se presentan los grafos de \emph{saltos de rana} para cada plan óptimo encontrado. \textbf{Se muestran todos los años desde 0 hasta 5.}\n
\begin{itemize}
\item \textcolor{green}{\textbf{Verde:}} Año inicial
\item \textcolor{red}{\textbf{Rojo:}} Año final
\item \textcolor{blue}{\textbf{Azul:}} Años utilizados en el plan
\item \textbf{Flechas verdes:} Saltos del plan óptimo
\item \textbf{Líneas punteadas:} Progresión temporal
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Reemplazo_20250925_plan_1.png}
...
\n\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Reemplazo_20250925_plan_2.png}
...
\n\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Reemplazo_20250925_plan_3.png}
