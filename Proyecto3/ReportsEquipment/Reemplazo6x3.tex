...
\begin{itemize}
\item Costo inicial (compra): \$600.00
\item Plazo del proyecto: 2 años
...
\bottomrule
\endlastfoot
0-1 & 1 año & $600 + 10 - 590$ & \$20.00 \\
0-2 & 2 años & $600 + 10 + 30 - 530$ & \$110.00 \\
1-2 & 1 año & $600 + 10 - 590$ & \$20.00 \\
\end{longtable}

\clearpage
\section*{Cálculo de $g(t)$ (Programación Dinámica)}
\begin{itemize}
\item $g(2) = 0$ (caso base)
\item $g(1) = \min\{ \mathbf{C_{1,2} + g(2) = 20.00}\} = \$20.00$ \textbf{(j=2)}
\item $g(0) = \min\{ \mathbf{C_{0,1} + g(1) = 40.00}, C_{0,2} + g(2) = 110.00\} = \$40.00$ \textbf{(j=1)}
\end{itemize}
...
\textbf{Costo mínimo total:} \$40.00\\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Reemplazo6x3_plan_1.png}
\caption{Plan Óptimo 1: \texttt{0-1-2}}
\label{fig:plan1}
\end{figure}

\textbf{Plan 1:} \texttt{0-1-2}
\begin{itemize}\small
\item Período 0-1: 1 año, Costo: \$20.00
\item Período 1-2: 1 año, Costo: \$20.00
\end{itemize}
